...
<p>
<span class="@if($summary['apti'][0]['tag'] >= 180) @if($summary['apti'][1]['tag'] >= 240) @if($summary['apti'][2]['tag'] >= 180) @if($summary['elec'][0]['tag'] >= 180) @if($summary['elec'][1]['tag'] >= 240) @if($summary['elec'][2]['tag'] >= 180) @if($summary['prog'][0]['tag'] >= 180) @if($summary['prog'][1]['tag'] >= 240) @if($summary['prog'][2]['tag'] >= 180) @if($summary['apti'][2]['tag'] >= 180) @if($summary['elec'][2]['tag'] >= 180) @if($summary['prog'][2]['tag'] >= 180) @if($summary['apti'][1]['tag'] >= 240) @if($summary['elec'][1]['tag'] >= 240) @if($summary['prog'][1]['tag'] >= 240) @if($summary['apti'][0]['tag'] >= 180) @if($summary['elec'][0]['tag'] >= 180) @if($summary['prog'][0]['tag'] >= 180) set-create @else hidden @endif  @else hidden @endif @else hidden @endif  @else hidden @endif  @else hidden @endif @else hidden @endif  @else hidden @endif  @else hidden @endif @else hidden @endif  @else hidden @endif  @else hidden @endif @else hidden @endif  @else hidden @endif  @else hidden @endif @else hidden @endif  @else hidden @endif  @else hidden @endif @else hidden @endif"><span class="label label-success">Click here to create set: <span id="setStatus"></span></span>
</p>